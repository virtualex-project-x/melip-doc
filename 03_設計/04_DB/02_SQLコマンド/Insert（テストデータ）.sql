...
insert into M_CD_VAL values (13, now(), 1, now(), 1, 0, '4', 'imgp', 'image path', 3);
insert into M_CD_VAL values (14, now(), 1, now(), 1, 0, '4', 'movp', 'movie path', 4);
...
insert into M_CD_VAL values (30, now(), 1, now(), 1, 0, '9', 'facgrp', 'facility group', 3);
insert into M_CD_VAL values (31, now(), 1, now(), 1, 0, '9', 'facgrpln', 'faciligy faciligy group link', 4);
