...
-- コード値_多言語
insert into M_CD_VAL_LANG values (1, now(), 1, now(), 1, 0, 0, '有効', 1);
insert into M_CD_VAL_LANG values (2, now(), 1, now(), 1, 0, 1, 'valid', 1);
insert into M_CD_VAL_LANG values (3, now(), 1, now(), 1, 0, 0, '無効', 2);
insert into M_CD_VAL_LANG values (4, now(), 1, now(), 1, 0, 1, 'invalid', 2);
insert into M_CD_VAL_LANG values (5, now(), 1, now(), 1, 0, 0, '削除', 3);
insert into M_CD_VAL_LANG values (6, now(), 1, now(), 1, 0, 1, 'delete', 3);
insert into M_CD_VAL_LANG values (7, now(), 1, now(), 1, 0, 0, '公開', 4);
insert into M_CD_VAL_LANG values (8, now(), 1, now(), 1, 0, 1, 'publish', 4);
insert into M_CD_VAL_LANG values (9, now(), 1, now(), 1, 0, 0, '非公開', 5);
insert into M_CD_VAL_LANG values (10, now(), 1, now(), 1, 0, 1, 'unpublish', 5);
insert into M_CD_VAL_LANG values (11, now(), 1, now(), 1, 0, 0, 'テキスト', 6);
insert into M_CD_VAL_LANG values (12, now(), 1, now(), 1, 0, 1, 'text', 6);
insert into M_CD_VAL_LANG values (13, now(), 1, now(), 1, 0, 0, 'コード', 7);
insert into M_CD_VAL_LANG values (14, now(), 1, now(), 1, 0, 1, 'code', 7);
insert into M_CD_VAL_LANG values (15, now(), 1, now(), 1, 0, 0, '日本語', 8);
insert into M_CD_VAL_LANG values (16, now(), 1, now(), 1, 0, 1, 'Japanese', 8);
insert into M_CD_VAL_LANG values (17, now(), 1, now(), 1, 0, 0, '英語', 9);
insert into M_CD_VAL_LANG values (18, now(), 1, now(), 1, 0, 1, 'English', 9);
insert into M_CD_VAL_LANG values (19, now(), 1, now(), 1, 0, 0, '共通', 10);
insert into M_CD_VAL_LANG values (20, now(), 1, now(), 1, 0, 1, 'Common', 10);
insert into M_CD_VAL_LANG values (21, now(), 1, now(), 1, 0, 0, '有り', 11);
insert into M_CD_VAL_LANG values (22, now(), 1, now(), 1, 0, 1, 'exists', 11);
insert into M_CD_VAL_LANG values (23, now(), 1, now(), 1, 0, 0, '無し', 12);
...
-- 施設_属性グループ_多言語
insert into M_FACILITY_ATTR_GRP_LANG values (1, now(), 1, now(), 1, 0, 1, 0, '施設名');
insert into M_FACILITY_ATTR_GRP_LANG values (2, now(), 1, now(), 1, 0, 1, 1, 'Facility Name');
insert into M_FACILITY_ATTR_GRP_LANG values (3, now(), 1, now(), 1, 0, 2, 0, '施設説明');
insert into M_FACILITY_ATTR_GRP_LANG values (4, now(), 1, now(), 1, 0, 2, 1, 'Facility Explain');
insert into M_FACILITY_ATTR_GRP_LANG values (5, now(), 1, now(), 1, 0, 3, 0, '駐車場有無');
...
-- 施設_属性値_多言語
insert into M_FACILITY_ATTR_VAL_LANG values (1, now(), 1, now(), 1, 0, 1, 0, 'ペンション寿々花');
insert into M_FACILITY_ATTR_VAL_LANG values (2, now(), 1, now(), 1, 0, 1, 1, 'Pension Suzuhana');
insert into M_FACILITY_ATTR_VAL_LANG values (3, now(), 1, now(), 1, 0, 2, 0, '富士山麓・山中湖畔の静かな別荘地にある寛ぎのペンション。ご家族や仲間との集いの場所としてぴったりです。');
...
insert into M_FACILITY_ATTR_VAL_LANG values (6, now(), 1, now(), 1, 0, 4, 0, 'ホテル　マウント富士');
insert into M_FACILITY_ATTR_VAL_LANG values (7, now(), 1, now(), 1, 0, 4, 1, 'Hotel Mt.Fuji');
insert into M_FACILITY_ATTR_VAL_LANG values (8, now(), 1, now(), 1, 0, 5, 0, '1,100ｍの高台から望む山中湖と富士山を見にお出掛け下さいませ♪');
...
insert into M_FACILITY_ATTR_VAL_LANG values (11, now(), 1, now(), 1, 0, 7, 0, 'ビュー山中湖');
insert into M_FACILITY_ATTR_VAL_LANG values (12, now(), 1, now(), 1, 0, 7, 1, 'View Yamanaka Lake');
insert into M_FACILITY_ATTR_VAL_LANG values (13, now(), 1, now(), 1, 0, 8, 0, '富士山と山中湖を望む閑静なたたずまい。ケーキ教室の先生でもあるママさんとおばあちゃんが作る手料理でおもてなしいたします。');
...
insert into M_FACILITY_FACILITY_GRP_LINK_ATTR_GRP_LANG values (1, now(), 1, now(), 1, 0, 1, 0, 'マリモの個数');
...
insert into M_FACILITY_FACILITY_GRP_LINK_ATTR_VAL_LANG values (1, now(), 1, now(), 1, 0, 1, 0, '2個');
insert into M_FACILITY_FACILITY_GRP_LINK_ATTR_VAL_LANG values (2, now(), 1, now(), 1, 0, 1, 1, 'two Marimos');
insert into M_FACILITY_FACILITY_GRP_LINK_ATTR_VAL_LANG values (3, now(), 1, now(), 1, 0, 2, 0, '1個');
...
-- 施設グループ_属性グループ_多言語
insert into M_FACILITY_GRP_ATTR_GRP_LANG values (1, now(), 1, now(), 1, 0, 1, 0, 'イベント名称');
insert into M_FACILITY_GRP_ATTR_GRP_LANG values (2, now(), 1, now(), 1, 0, 1, 1, 'Ivent Name');
insert into M_FACILITY_GRP_ATTR_GRP_LANG values (3, now(), 1, now(), 1, 0, 2, 0, 'イベント説明');
...
-- 施設グループ_属性値_多言語
insert into M_FACILITY_GRP_ATTR_VAL_LANG values (1, now(), 1, now(), 1, 0, 1, 0, 'ホテルでマリモをもらおう！');
insert into M_FACILITY_GRP_ATTR_VAL_LANG values (2, now(), 1, now(), 1, 0, 1, 1, 'Marimo Get!');
insert into M_FACILITY_GRP_ATTR_VAL_LANG values (3, now(), 1, now(), 1, 0, 2, 0, '参加ホテルに行くとマリモがもらえるよ☆');
...
-- 地域_属性グループ_多言語
insert into M_REGION_ATTR_GRP_LANG values (1, now(), 1, now(), 1, 0, 1, 0, '地域名');
insert into M_REGION_ATTR_GRP_LANG values (2, now(), 1, now(), 1, 0, 1, 1, 'Region Name');
insert into M_REGION_ATTR_GRP_LANG values (3, now(), 1, now(), 1, 0, 2, 0, '地域説明');
insert into M_REGION_ATTR_GRP_LANG values (4, now(), 1, now(), 1, 0, 2, 1, 'Region Explain');
insert into M_REGION_ATTR_GRP_LANG values (5, now(), 1, now(), 1, 0, 3, 0, '駐車場有無');
...
-- 地域_属性値_多言語
insert into M_REGION_ATTR_VAL_LANG values (1, now(), 1, now(), 1, 0, 1, 0, '富士五湖');
insert into M_REGION_ATTR_VAL_LANG values (2, now(), 1, now(), 1, 0, 1, 1, 'The Five Lakes of Mt.Fuji');
insert into M_REGION_ATTR_VAL_LANG values (3, now(), 1, now(), 1, 0, 2, 0, '富士山を囲む5つの湖');
