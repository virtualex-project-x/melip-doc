...
insert into M_CD_VAL values (17, now(), 1, now(), 1, 0, '5', 'disclose', 'Disclose', 1);
insert into M_CD_VAL values (18, now(), 1, now(), 1, 0, '5', 'close', 'Close', 2);
...
insert into M_CD_VAL values (21, now(), 1, now(), 1, 0, '7', 'text', 'Text', 1);
insert into M_CD_VAL values (22, now(), 1, now(), 1, 0, '7', 'image', 'Image', 2);
insert into M_CD_VAL values (23, now(), 1, now(), 1, 0, '7', 'movie', 'Movie', 3);
insert into M_CD_VAL values (24, now(), 1, now(), 1, 0, '7', 'map', 'Map', 4);
insert into M_CD_VAL values (25, now(), 1, now(), 1, 0, '7', 'button', 'Button', 5);
insert into M_CD_VAL values (26, now(), 1, now(), 1, 0, '8', 'single', 'Single', 1);
insert into M_CD_VAL values (27, now(), 1, now(), 1, 0, '8', 'multiple', 'Multiple', 2);
insert into M_CD_VAL values (28, now(), 1, now(), 1, 0, '9', 'region', 'Region', 1);
insert into M_CD_VAL values (29, now(), 1, now(), 1, 0, '9', 'facility', 'Facility', 2);
...
insert into M_CD_VAL values (32, now(), 1, now(), 1, 0, '10', 'eat', 'Eat', 1);
insert into M_CD_VAL values (33, now(), 1, now(), 1, 0, '10', 'shop', 'Shop', 2);
insert into M_CD_VAL values (34, now(), 1, now(), 1, 0, '10', 'play', 'Play', 3);
insert into M_CD_VAL values (35, now(), 1, now(), 1, 0, '10', 'see', 'See', 4);
insert into M_CD_VAL values (36, now(), 1, now(), 1, 0, '10', 'stay', 'Stay', 5);
insert into M_CD_VAL values (37, now(), 1, now(), 1, 0, '10', 'event', 'Event', 6);
insert into M_CD_VAL values (38, now(), 1, now(), 1, 0, '11', 'other', 'Other', 16);
insert into M_CD_VAL values (39, now(), 1, now(), 1, 0, '12', 'other', 'Other', 12);
insert into M_CD_VAL values (40, now(), 1, now(), 1, 0, '13', 'other', 'Other', 18);
insert into M_CD_VAL values (41, now(), 1, now(), 1, 0, '14', 'museum', 'Museum', 5);
insert into M_CD_VAL values (42, now(), 1, now(), 1, 0, '14', 'other', 'Other', 9);
insert into M_CD_VAL values (43, now(), 1, now(), 1, 0, '15', 'other', 'Other', 6);
insert into M_CD_VAL values (44, now(), 1, now(), 1, 0, '16', 'other', 'Other', 24);
...
insert into M_CD_VAL_LANG values (40, now(), 1, now(), 1, 0, '32', 'ja', '食べる');
insert into M_CD_VAL_LANG values (41, now(), 1, now(), 1, 0, '33', 'ja', '買う');
insert into M_CD_VAL_LANG values (42, now(), 1, now(), 1, 0, '34', 'ja', '遊ぶ');
insert into M_CD_VAL_LANG values (43, now(), 1, now(), 1, 0, '35', 'ja', '見る');
insert into M_CD_VAL_LANG values (44, now(), 1, now(), 1, 0, '36', 'ja', '泊まる');
insert into M_CD_VAL_LANG values (45, now(), 1, now(), 1, 0, '37', 'ja', 'イベント');
insert into M_CD_VAL_LANG values (46, now(), 1, now(), 1, 0, '37', 'ja', '居酒屋');
insert into M_CD_VAL_LANG values (47, now(), 1, now(), 1, 0, '37', 'ja', 'ダイニングバー');
insert into M_CD_VAL_LANG values (48, now(), 1, now(), 1, 0, '37', 'ja', '創作料理');
insert into M_CD_VAL_LANG values (49, now(), 1, now(), 1, 0, '37', 'ja', '和食');
insert into M_CD_VAL_LANG values (50, now(), 1, now(), 1, 0, '37', 'ja', '洋食');
insert into M_CD_VAL_LANG values (51, now(), 1, now(), 1, 0, '37', 'ja', 'イタリアン・フレンチ');
insert into M_CD_VAL_LANG values (52, now(), 1, now(), 1, 0, '37', 'ja', '中華');
insert into M_CD_VAL_LANG values (53, now(), 1, now(), 1, 0, '37', 'ja', '焼き肉・韓国料理');
insert into M_CD_VAL_LANG values (54, now(), 1, now(), 1, 0, '37', 'ja', 'アジアン');
insert into M_CD_VAL_LANG values (55, now(), 1, now(), 1, 0, '37', 'ja', '各国料理');
insert into M_CD_VAL_LANG values (56, now(), 1, now(), 1, 0, '37', 'ja', 'カラオケ・パーティー');
insert into M_CD_VAL_LANG values (57, now(), 1, now(), 1, 0, '37', 'ja', 'バー・カクテル');
insert into M_CD_VAL_LANG values (58, now(), 1, now(), 1, 0, '37', 'ja', 'ラーメン');
insert into M_CD_VAL_LANG values (59, now(), 1, now(), 1, 0, '37', 'ja', 'お好み焼き・もんじゃ・鉄板焼き');
insert into M_CD_VAL_LANG values (60, now(), 1, now(), 1, 0, '37', 'ja', 'カフェ・スイーツ');
insert into M_CD_VAL_LANG values (61, now(), 1, now(), 1, 0, '38', 'ja', 'その他');
insert into M_CD_VAL_LANG values (62, now(), 1, now(), 1, 0, '38', 'ja', '本・コミック・雑誌');
insert into M_CD_VAL_LANG values (63, now(), 1, now(), 1, 0, '38', 'ja', 'DVD・ミュージック・ゲーム');
insert into M_CD_VAL_LANG values (64, now(), 1, now(), 1, 0, '38', 'ja', '家電・カメラ・AV機器');
insert into M_CD_VAL_LANG values (65, now(), 1, now(), 1, 0, '38', 'ja', 'パソコン・オフィス用品');
insert into M_CD_VAL_LANG values (66, now(), 1, now(), 1, 0, '38', 'ja', 'ホーム＆キッチン・ペット');
insert into M_CD_VAL_LANG values (67, now(), 1, now(), 1, 0, '38', 'ja', '食品・飲料・お酒');
insert into M_CD_VAL_LANG values (68, now(), 1, now(), 1, 0, '38', 'ja', 'ヘルス＆ビューティー');
insert into M_CD_VAL_LANG values (69, now(), 1, now(), 1, 0, '38', 'ja', 'ベビー・おもちゃ・ホビー');
insert into M_CD_VAL_LANG values (70, now(), 1, now(), 1, 0, '38', 'ja', 'ファッション・バッグ・腕時計');
insert into M_CD_VAL_LANG values (71, now(), 1, now(), 1, 0, '38', 'ja', 'スポーツ＆アウトドア');
insert into M_CD_VAL_LANG values (72, now(), 1, now(), 1, 0, '38', 'ja', 'DIY・カー＆バイク用品');
insert into M_CD_VAL_LANG values (73, now(), 1, now(), 1, 0, '39', 'ja', 'その他');
insert into M_CD_VAL_LANG values (74, now(), 1, now(), 1, 0, '39', 'ja', '公園');
insert into M_CD_VAL_LANG values (75, now(), 1, now(), 1, 0, '39', 'ja', 'キャンプ場');
insert into M_CD_VAL_LANG values (76, now(), 1, now(), 1, 0, '39', 'ja', '海水浴場');
insert into M_CD_VAL_LANG values (77, now(), 1, now(), 1, 0, '39', 'ja', 'プール');
insert into M_CD_VAL_LANG values (78, now(), 1, now(), 1, 0, '39', 'ja', '釣り堀');
insert into M_CD_VAL_LANG values (79, now(), 1, now(), 1, 0, '39', 'ja', '牧場');
insert into M_CD_VAL_LANG values (80, now(), 1, now(), 1, 0, '39', 'ja', '遊園地・テーマパーク');
insert into M_CD_VAL_LANG values (81, now(), 1, now(), 1, 0, '39', 'ja', 'カラオケ');
insert into M_CD_VAL_LANG values (82, now(), 1, now(), 1, 0, '39', 'ja', 'ゲームセンター');
insert into M_CD_VAL_LANG values (83, now(), 1, now(), 1, 0, '39', 'ja', 'クラブ・ディスコ');
insert into M_CD_VAL_LANG values (84, now(), 1, now(), 1, 0, '39', 'ja', 'ボウリング場');
insert into M_CD_VAL_LANG values (85, now(), 1, now(), 1, 0, '39', 'ja', 'ビリヤード');
insert into M_CD_VAL_LANG values (86, now(), 1, now(), 1, 0, '39', 'ja', '競輪・競馬・競艇');
insert into M_CD_VAL_LANG values (87, now(), 1, now(), 1, 0, '39', 'ja', 'オートレース場');
insert into M_CD_VAL_LANG values (88, now(), 1, now(), 1, 0, '39', 'ja', 'パチンコ・パチスロ');
insert into M_CD_VAL_LANG values (89, now(), 1, now(), 1, 0, '39', 'ja', '雀荘');
insert into M_CD_VAL_LANG values (90, now(), 1, now(), 1, 0, '39', 'ja', '漫画喫茶');
insert into M_CD_VAL_LANG values (91, now(), 1, now(), 1, 0, '40', 'ja', 'その他');
insert into M_CD_VAL_LANG values (92, now(), 1, now(), 1, 0, '40', 'ja', '動物園');
insert into M_CD_VAL_LANG values (93, now(), 1, now(), 1, 0, '40', 'ja', '植物園');
insert into M_CD_VAL_LANG values (94, now(), 1, now(), 1, 0, '40', 'ja', '水族館');
insert into M_CD_VAL_LANG values (95, now(), 1, now(), 1, 0, '40', 'ja', '映画館');
insert into M_CD_VAL_LANG values (96, now(), 1, now(), 1, 0, '41', 'ja', '博物館');
insert into M_CD_VAL_LANG values (97, now(), 1, now(), 1, 0, '41', 'ja', '美術館');
insert into M_CD_VAL_LANG values (98, now(), 1, now(), 1, 0, '41', 'ja', '天文台・プラネタリム');
insert into M_CD_VAL_LANG values (99, now(), 1, now(), 1, 0, '41', 'ja', '劇場');
insert into M_CD_VAL_LANG values (100, now(), 1, now(), 1, 0, '42', 'ja', 'その他');
insert into M_CD_VAL_LANG values (101, now(), 1, now(), 1, 0, '42', 'ja', 'ホテル');
insert into M_CD_VAL_LANG values (102, now(), 1, now(), 1, 0, '42', 'ja', '旅館');
insert into M_CD_VAL_LANG values (103, now(), 1, now(), 1, 0, '42', 'ja', '民宿');
insert into M_CD_VAL_LANG values (104, now(), 1, now(), 1, 0, '42', 'ja', '温泉');
insert into M_CD_VAL_LANG values (105, now(), 1, now(), 1, 0, '42', 'ja', 'カプセルホテル');
insert into M_CD_VAL_LANG values (106, now(), 1, now(), 1, 0, '43', 'ja', 'その他');
insert into M_CD_VAL_LANG values (107, now(), 1, now(), 1, 0, '43', 'ja', '節句・年中行事');
insert into M_CD_VAL_LANG values (108, now(), 1, now(), 1, 0, '43', 'ja', '神輿・山車など');
insert into M_CD_VAL_LANG values (109, now(), 1, now(), 1, 0, '43', 'ja', '伝統芸能・舞踊');
insert into M_CD_VAL_LANG values (110, now(), 1, now(), 1, 0, '43', 'ja', '行列・パレード');
insert into M_CD_VAL_LANG values (111, now(), 1, now(), 1, 0, '43', 'ja', 'グルメ');
insert into M_CD_VAL_LANG values (112, now(), 1, now(), 1, 0, '43', 'ja', '市・縁日');
insert into M_CD_VAL_LANG values (113, now(), 1, now(), 1, 0, '43', 'ja', '花見・自然');
insert into M_CD_VAL_LANG values (114, now(), 1, now(), 1, 0, '43', 'ja', '火と灯の祭り');
insert into M_CD_VAL_LANG values (115, now(), 1, now(), 1, 0, '43', 'ja', '花火大会');
insert into M_CD_VAL_LANG values (116, now(), 1, now(), 1, 0, '43', 'ja', '雪・冬祭り');
insert into M_CD_VAL_LANG values (117, now(), 1, now(), 1, 0, '43', 'ja', 'イルミネーション');
insert into M_CD_VAL_LANG values (118, now(), 1, now(), 1, 0, '43', 'ja', '音楽・映画');
insert into M_CD_VAL_LANG values (119, now(), 1, now(), 1, 0, '43', 'ja', 'スポーツ');
insert into M_CD_VAL_LANG values (120, now(), 1, now(), 1, 0, '43', 'ja', '美術展・博物展');
insert into M_CD_VAL_LANG values (121, now(), 1, now(), 1, 0, '43', 'ja', '博覧会・フェスティバル');
insert into M_CD_VAL_LANG values (122, now(), 1, now(), 1, 0, '43', 'ja', 'ペット・動物');
insert into M_CD_VAL_LANG values (123, now(), 1, now(), 1, 0, '43', 'ja', '体験イベント');
insert into M_CD_VAL_LANG values (124, now(), 1, now(), 1, 0, '43', 'ja', '講演会・トークショー');
insert into M_CD_VAL_LANG values (125, now(), 1, now(), 1, 0, '43', 'ja', '演劇・舞台');
insert into M_CD_VAL_LANG values (126, now(), 1, now(), 1, 0, '43', 'ja', 'テーマパーク');
insert into M_CD_VAL_LANG values (127, now(), 1, now(), 1, 0, '43', 'ja', '動物園・水族館');
insert into M_CD_VAL_LANG values (128, now(), 1, now(), 1, 0, '43', 'ja', '記念日');
insert into M_CD_VAL_LANG values (129, now(), 1, now(), 1, 0, '43', 'ja', '即売会・フェア');
insert into M_CD_VAL_LANG values (130, now(), 1, now(), 1, 0, '44', 'ja', 'その他');
...
-- 施設（insert文）
insert into M_FACILITY values (1, now(), 1, now(), 1, 'val', 1, 'dcls', null);
insert into M_FACILITY values (2, now(), 1, now(), 1, 'val', 1, 'dcls', null);
insert into M_FACILITY values (3, now(), 1, now(), 1, 'val', 2, 'dcls', null);
insert into M_FACILITY values (4, now(), 1, now(), 1, 'val', 2, 'dcls', null);
